...
module.exports = async (args, client, message) => {
    ...
    //Text WIP
    ctx.text3(messagejson[lang].statsdisabled, 230, 2000, canvasstats.height / 2, '#ffffff', 'center')
    ...
    if (!args.length) {
      ...
      if(!linkjson[author]) {
        const Embed = new Discord.MessageEmbed()
            .setColor('#ee3054')
            .setTitle(messagejson[lang].statslinksyntax)
            .setDescription(messagejson[lang].statslinkdesc)
            .setTimestamp()
  ...
  */
    ...
    if(name == null || tag == null) {
      const Embed = new Discord.MessageEmbed()
          .setColor('#ee3054')
          .setTitle(messagejson[lang].statslinksyntax)
          .setDescription(messagejson[lang].statssyntax)
          .setTimestamp()
          .setFooter('VALORANT LABS [ERROR]')
      message.channel.send(Embed)
      message.channel.stopTyping()
