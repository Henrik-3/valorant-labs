...
export async function execute({interaction, guilddata} = {}) {
    ...
    switch(interaction.options._subcommand) {
        ...
        case "remove": {
            ...
            if(uchannel == null) return interaction.editReply({embeds: [Utils.embedBuilder({title: Utils.translations[guilddata.lang].blacklist.blacklistalreadyremoved_title, desc: Utils.translations[guilddata.lang].blacklist.blacklistalreadyremoved_desc, footer: 'VALORANT LABS [SETTINGS]'})]})
