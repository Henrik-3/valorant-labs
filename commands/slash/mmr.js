...
export async function execute({interaction, guilddata} = {}) {
    ...
    if(!dbcheck) {
        ...
        if(topggusage && topggusage.current >= 55) return interaction.editReply({embeds: [{title: Utils.translations[guilddata.lang].mmr["429_title"], description: Utils.translations[guilddata.lang].mmr["429_desc"], color: 0xff4654, timestamp: new Date().toISOString(), footer: {text: 'VALORANT LABS [MMR TOP.GG ERROR]', icon_url: "https://valorantlabs.xyz/css/valorant-logo.png"}}]})
        ...
        if(topggvote.response) return interaction.editReply({embeds: [{title: Utils.translations[guilddata.lang].mmr["500_title"], description: Utils.translations[guilddata.lang].mmr["500_desc"], color: 0xff4654, timestamp: new Date().toISOString(), footer: {text: 'VALORANT LABS [MMR TOP.GG ERROR]', icon_url: "https://valorantlabs.xyz/css/valorant-logo.png"}}]})
        if(topggvote.data.voted != 1) return interaction.editReply({embeds: [{title: Utils.translations[guilddata.lang].mmr.not_voted_title, description: Utils.translations[guilddata.lang].mmr.not_voted_desc, color: 0xff4654, timestamp: new Date().toISOString(), footer: {text: 'VALORANT LABS [MMR NOT VOTED]', icon_url: "https://valorantlabs.xyz/css/valorant-logo.png"}}], components: [{type: 1, components: [{type: 2, url: "https://top.gg/bot/702201518329430117/vote", style: 5, label: "top.gg"}]}]})
    ...
    if(!link && !interaction.options.get("riot-id")) return interaction.editReply({embeds: [{title: Utils.translations[guilddata.lang].mmr.no_link_title, description: Utils.translations[guilddata.lang].mmr.no_link_desc, fields: [{name: `/mmr`, value: Utils.translations[guilddata.lang].mmr.base}, {name: `/mmr riot-id`, value: Utils.translations[guilddata.lang].mmr.options}], color: 0xff4654, timestamp: new Date().toISOString(), footer: {text: 'VALORANT LABS [MMR TOP.GG ERROR]', icon_url: "https://valorantlabs.xyz/css/valorant-logo.png"}}], components: [{type: "ACTION_ROW", components: [{type: "BUTTON", label: Utils.translations[guilddata.lang].support, style: "LINK", url: "https://discord.gg/Zr5eF5D"}]}]})
