...
export async function execute({interaction, guilddata} = {}) {
    ...
    if(cagent == undefined) return interaction.editReply({embeds: [Utils.embedBuilder({title: Utils.translations[guilddata.lang].agent.agentunknown_title, desc: Utils.translations[guilddata.lang].agent.agentunknown_desc, footer: `VALORANT LABS [AGENT ERROR]`})], components: [{type: Utils.EnumResolvers.resolveComponentType("ACTION_ROW"), components: [{type: Utils.EnumResolvers.resolveComponentType("BUTTON"), label: Utils.translations[guilddata.lang].support, style: Utils.EnumResolvers.resolveButtonStyle("LINK"), url: "https://discord.gg/Zr5eF5D"}]}]})
