import {axios, embedBuilder} from '../../methods.js';
...
export async function execute({interaction, guilddata} = {}) {
    ...
    if (request.response) return errorhandlerinteraction({interaction, status: request.response.status, type: 'map', lang: guilddata.lang, data: request.response.data});
