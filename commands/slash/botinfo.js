    ...
    return interaction.editReply({
        embeds: [embedBuilder({
            ...
            additionalFields: [
                ...
                {name: "CPU", value: `AMD Epyc 7702 (8C@3GHz) | Load: ${sysdata.currentLoad.currentLoad.toFixed(2)}%`, inline: false},
                {name: "Memory", value: `Total: ${pretty(sysdata.mem.total, {locale: 'en'})} | Free: ${pretty(sysdata.mem.free, {locale: 'en'})} | Used: ${pretty(sysdata.mem.used, {locale: 'en'})}`, inline: false},
